...
public class MainActivity extends AppCompatActivity {
    ...
    private void setClickListener() {
        ...
        findViewById(R.id.activity_main_btn_animation).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Toast.makeText(MainActivity.this, "请参考AnimatorDemo", Toast.LENGTH_SHORT).show();
            }
        });
    }
}
